...
QUIPUCORDS_AUTH_INSIGHTS_TIMEOUT = env.int(
    "QUIPUCORDS_AUTH_INSIGHTS_TIMEOUT", default=QUIPUCORDS_AUTH_TIMEOUT
)

# Settings for authenticating to and accessing console.redhat.com
QUIPUCORDS_INSIGHTS_HOST = env.str(
    "QUIPUCORDS_INSIGHTS_HOST", default="console.redhat.com"
)
QUIPUCORDS_INSIGHTS_PORT = env.int("QUIPUCORDS_INSIGHTS_PORT", default=443)
QUIPUCORDS_INSIGHTS_USE_HTTP = env.bool("QUIPUCORDS_INSIGHTS_USE_HTTP", default=False)
QUIPUCORDS_INSIGHTS_SSL_VERIFY = env.bool(
    "QUIPUCORDS_INSIGHTS_SSL_VERIFY", default=True
)
QUIPUCORDS_INSIGHTS_SSO_HOST = env.str(
    "QUIPUCORDS_INSIGHTS_SSO_HOST", default="sso.redhat.com"
)
