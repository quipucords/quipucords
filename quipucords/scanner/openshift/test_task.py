...
@pytest.mark.parametrize(
    "source_kwargs,expected_protocol",
    [
        ({"source__options": None}, "https"),
        ({"source__options__ssl_cert_verify": True}, "https"),
        ({"source__options__ssl_cert_verify": False}, "http"),
    ],
)
def test_get_ocp_client_arguments(  # pylint: disable=too-many-arguments
    patched_ocp_client, auth_token, host, port, source_kwargs, expected_protocol
):
