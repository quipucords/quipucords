    ...
    def test_not_result_sudo_error(self):
        ...
        self.assertEqual(
            process.process(self.scan_task,
                            ...
                            HOST), {NOT_TASK_RESULT_KEY: process.NO_DATA})
    ...
    def test_missing_dependency(self):
        ...
        self.assertEqual(
            process.process(self.scan_task,
                            ...
                            HOST), {DEPENDENT_KEY: process.NO_DATA})
        ...
        self.assertEqual(
            process.process(self.scan_task,
                            {NO_PROCESSOR_KEY: 'result',
                             DEPENDENT_KEY: ansible_result('')},
                            HOST),
            {NO_PROCESSOR_KEY: 'result', DEPENDENT_KEY: '2'})
