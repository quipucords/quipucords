...
def list_or_none(value: list) -> list | None:
    """Normalize value as list or return None."""
    if isinstance(value, list):
        return value
    logger.error("value '%s' is NOT a list")


def dict_or_none(value: dict) -> dict | None:
    """Normalize value as dict or return None."""
    if isinstance(value, dict):
        return value
    logger.error("value '%s' is NOT a dict")


def date_or_none(
    value: datetime.date | datetime.datetime | Any,
) -> datetime.date | None:
