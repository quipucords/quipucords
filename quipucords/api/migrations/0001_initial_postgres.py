# Generated by Django 2.0 on 2018-10-15 21:52
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('report_id', models.IntegerField(null=True)),
                ('cached_csv', models.TextField(null=True)),
                ('deployment_report', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='fact_collection', to='api.DeploymentReport')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('metadata', models.TextField()),
                ('sources', models.TextField()),
                ('deployment_report', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='system_fingerprints', to='api.DeploymentReport')),
            ],
        ),
        migrations.CreateModel(
