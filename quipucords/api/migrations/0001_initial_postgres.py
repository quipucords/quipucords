# Generated by Django 2.0 on 2018-11-09 15:27
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('details_report', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, to='api.DetailsReport')),
                ('inspection_results', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, to='api.JobInspectionResult')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('disabled_optional_products', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, to='api.DisabledOptionalProductsOptions')),
                ('enabled_extended_product_search', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, to='api.ExtendedProductSearchOptions')),
            ],
        ),
        migrations.CreateModel(
            name='ScanTask',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('infrastructure_type', models.CharField(choices=[('bare_metal', 'Bare Metal'), ('virtualized', 'Virtualized'), ('unknown', 'Unknown')], max_length=12)),
                ...
                ('system_intent_role', models.CharField(max_length=128, null=True)),
                ('system_intent_addons', models.TextField(null=True)),
                ('system_intent_sla', models.CharField(max_length=128, null=True)),
                ('system_intent_usage_type', models.CharField(max_length=128, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('job_inspection_result', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='task_results', to='api.JobInspectionResult')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='systems', to='api.TaskInspectionResult'),
        ),
        migrations.AddField(
            model_name='systemconnectionresult',
            name='task_connection_result',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='systems', to='api.TaskConnectionResult'),
        ),
        migrations.AddField(
            model_name='source',
            name='options',
            field=models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, to='api.SourceOptions'),
        ),
        migrations.AddField(
            model_name='scantask',
            name='connection_result',
            field=models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, to='api.TaskConnectionResult'),
        ),
        migrations.AddField(
            model_name='scantask',
            name='details_report',
        ...
        migrations.AddField(
            ...
            field=models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, to='api.TaskInspectionResult'),
        ),
        migrations.AddField(
            model_name='scantask',
            name='job',
        ...
        migrations.AddField(
            model_name='scanjob',
            name='options',
            field=models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, to='api.ScanOptions'),
        ),
        migrations.AddField(
            model_name='scanjob',
            name='scan',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='facts', to='api.SystemInspectionResult'),
        ),
        migrations.AddField(
            model_name='product',
            name='fingerprint',
