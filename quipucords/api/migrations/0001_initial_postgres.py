# -*- coding: utf-8 -*-
# Generated by Django 1.11.5 on 2018-09-21 15:18
...
class Migration(migrations.Migration):
    ...
    replaces = [('api', '0001_initial'), ('api', '0002_source_exclude_hosts'), ('api', '0003_jws_and_paramiko'), ('api', '0004_postgres_support')]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status_message', models.CharField(default='Job is created.', max_length=256, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('scan_type', models.CharField(choices=[('connect', 'connect'), ('inspect', 'inspect')], max_length=9)),
                ...
                ('status_message', models.CharField(default='Task is pending.', max_length=256, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=64, unique=True)),
                ('source_type', models.CharField(choices=[('network', 'network'), ('vcenter', 'vcenter'), ('satellite', 'satellite')], max_length=7)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vm_dns_name', models.CharField(max_length=128, null=True)),
        ...
        migrations.AddField(
            model_name='scanjob',
            name='scan',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='jobs', to='api.Scan'),
        ),
        migrations.AddField(
            model_name='scanjob',
            name='sources',
