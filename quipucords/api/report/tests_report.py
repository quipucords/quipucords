...
class DeploymentReportTest(TestCase):
    ...
    def test_csv_renderer(self):
        ...
        expected = 'Report\r\n1\r\n\r\n\r\nReport:\r\narchitecture,bios_uuid,cpu_core_count,cpu_count,cpu_socket_count,detection-network,detection-satellite,detection-vcenter,infrastructure_type,ip_addresses,jboss brms,jboss eap,jboss fuse,mac_addresses,name,os_name,os_release,os_version,redhat_is_redhat,redhat_packages_certs,redhat_packages_gpg_num_redhat_packages,sources,subman_consumed,subscription_manager_id,system_creation_date,system_last_checkin_date,virtualized_type,vm_cluster,vm_datacenter,vm_dns_name,vm_host,vm_host_socket_count,vm_state,vm_uuid\r\n,,2,2,2,True,False,False,virtualized,,absent,absent,absent,,1.2.3.4,RHEL,RHEL 7.4,7.4,,,,[test_source],,,2017-07-18,,vmware,,,,,,,\r\n,,2,2,2,True,False,False,virtualized,,absent,absent,absent,,1.2.3.4,RHEL,RHEL 7.4,7.4,,,,[test_source],,,2017-07-18,,vmware,,,,,,,\r\n,,2,2,2,True,False,False,virtualized,,absent,absent,absent,,1.2.3.4,RHEL,RHEL 7.5,7.5,,,,[test_source],,,2017-07-18,,vmware,,,,,,,\r\n\r\n'  # noqa
        self.assertEqual(csv_result, expected)
