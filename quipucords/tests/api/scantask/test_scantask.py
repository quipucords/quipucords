...
from tests.factories import InspectResultFactory, ResultSetFactory, ScanTaskFactory
...
def test_cleanup_facts():
    ...
    results = InspectResultFactory.create_batch(5, result_set=result_set)
    scan_task.result_sets.add(result_set)
