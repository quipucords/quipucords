...
# @pytest.fixture
# def source_ssh(network_credential):
#     """Return a Source with an SSH Credential for scan."""
#     source_ssh = Source.objects.create(name="source_ssh", port=22, hosts=["1.2.3.5"])
#     source_ssh.credentials.add(network_credential)
#     return source_ssh


# @pytest.fixture
# def host_ssh_list(network_credential: Credential):
