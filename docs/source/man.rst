...
**qpc cred add --name=** *name* **--type=** *(network | vcenter | satellite)* **--username=** *username* **(--password | --sshkeyfile=** *key_file* **)** **[--sshpassphrase]** **[--sudo-password]** **--become_method=** *(sudo | su | pbrun | pfexec | doas | dzdo | ksu | runas )* **--become_user=** *user* **[--become_password]**
...
**qpc cred edit --name=** *name* **--username=** *username* **(--password | --sshkeyfile=** *key_file* **)** **[--sshpassphrase]** **[--sudo-password]** **--become_method=** *(sudo | su | pbrun | pfexec | doas | dzdo | ksu | runas )* **--become_user=** *user* **[--become_password]**
